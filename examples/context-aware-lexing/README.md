...
selects `INT_LITERAL`, followed by aggregate overlap statistics. The summary
reports both raw lexer-rule overlaps and effective overlaps remaining after
parser-context filtering.
