...
kons_kopf                : (modulkopf_info)?
                             (funktionsdef)?
                             (variantendef)?
                         ;

modulkopf_info           : (mod_zeile)+
                         ;

mod_zeile                : mod_anf_zeile
                           (mod_fort_zeile)*
                         ;

mod_anf_zeile            : 'MODULKOPF' mod_ele_name mod_ele_wert
                         ;

mod_fort_zeile           : 'MODULKOPF' mod_ele_wert
                         ;
...
funktionszeile           : 'FKT' NAME fkt_version fkt_langname
                         ;
...
kf_zeile_liste           : (kf_zeile_liste_r+
                         | kf_zeile_liste_tx+)
                         ;

kf_zeile_liste_r         : ('ST/Y' realzahl '\n'
                            werteliste+)
                         ;

kf_zeile_liste_tx        : ('ST_TX/Y' TEXT '\n'
                             werteliste+)
                         ;
