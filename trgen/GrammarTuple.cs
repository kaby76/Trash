namespace Trash
{
    ...
    {
        public GrammarTuple(string grammar_file_name, string grammar_name, string generated_file_name, string generated_include_file_name, string grammar_autom_name)
        {
