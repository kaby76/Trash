...
do
	...
	rm -f asdfasdf2
	touch readme.md
	cat readme.md | sed -e 's%^0[.][0-9]*[.][0-9]*.*$'"%$version"' Major change to trgen templates and processing of STG, ST, and plain files. NB: not all Trash tools supported yet.%' > asdfasdf2
