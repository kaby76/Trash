...
dotnet nuget add source $cwd\\tranalyze\\bin\\Debug\\ --name "nuget-tranalyze"
...
dotnet nuget add source $cwd\\trrename\\bin\\Debug\\ --name "nuget-trrename"
...
dotnet nuget add source $cwd\\trwdog\\bin\\Debug\\ --name "nuget-trwdog"
...
dotnet nuget add source $cwd\\trxml2\\bin\\Debug\\ --name "nuget-trxml2"
