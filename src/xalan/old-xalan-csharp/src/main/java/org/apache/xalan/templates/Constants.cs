...
namespace org.apache.xalan.templates
{
	...
	/// @xsl.usage advanced
	/// </summary>
	public class Constants : org.apache.xml.utils.Constants
	{
	  ...
	  /// 
	  /// </summary>
	  public const string ATTRVAL_OUTPUT_METHOD_HTML = "html", ATTRVAL_OUTPUT_METHOD_XML = "xml", ATTRVAL_OUTPUT_METHOD_TEXT = "text";


	  /* For space-att*/
	  public const int ATTRVAL_PRESERVE = 1, ATTRVAL_STRIP = 2;


	  /// <summary>
	  /// For indent-result </summary>
	  public const bool ATTRVAL_YES = true, ATTRVAL_NO = false;


	  /// <summary>
	  /// For letter-value attribute (part of conversion attributes). </summary>
	  public const string ATTRVAL_ALPHABETIC = "alphabetic", ATTRVAL_OTHER = "other", ATTRVAL_TRADITIONAL = "traditional";


	  /// <summary>
	  /// For level attribute in xsl:number. </summary>
	  public const string ATTRVAL_SINGLE = "single", ATTRVAL_MULTI = "multiple", ATTRVAL_ANY = "any";


	  /// <summary>
	  /// For Stylesheet-prefix and result-prefix in xsl:namespace-alias </summary>
	  public const string ATTRVAL_DEFAULT_PREFIX = "#default";

	 /// <summary>
	 /// Integer equivalents for above </summary>
	  public const int NUMBERLETTER_ALPHABETIC = 1, NUMBERLETTER_TRADITIONAL = 2;

	  /// <summary>
	  /// Integer equivelents for above </summary>
	  public const int NUMBERLEVEL_SINGLE = 1, NUMBERLEVEL_MULTI = 2, NUMBERLEVEL_ANY = 3, MAX_MULTI_COUNTING_DEPTH = 32;


	  /// <summary>
	  /// some stuff for my patterns-by-example </summary>
	  public const string ATTRVAL_THIS = ".", ATTRVAL_PARENT = "..", ATTRVAL_ANCESTOR = "ancestor", ATTRVAL_ID = "id";


	  /// <summary>
	  /// Stuff for sorting </summary>
	  public const string ATTRVAL_DATATYPE_TEXT = "text", ATTRVAL_DATATYPE_NUMBER = "number", ATTRVAL_ORDER_ASCENDING = "ascending", ATTRVAL_ORDER_DESCENDING = "descending", ATTRVAL_CASEORDER_UPPER = "upper-first", ATTRVAL_CASEORDER_LOWER = "lower-first";

	 /// <summary>
	 /// Integer equivelents for DATATYPE attribute </summary>
	  public const int SORTDATATYPE_TEXT = 1, SORTDATATYPE_NUMBER = 2;

	  /// <summary>
	  /// Integer equivelents for ORDER attribute </summary>
	  public const int SORTORDER_ASCENDING = 1, SORTORDER_DESCENDING = 2;

	  /// <summary>
	  /// Integer equivelents for CASE-ORDER attribute </summary>
	  public const int SORTCASEORDER_UPPERFIRST = 1, SORTCASEORDER_LOWERFIRST = 2;

	  /// <summary>
	  /// some stuff for Decimal-format </summary>
	  public const string ATTRVAL_INFINITY = "Infinity", ATTRVAL_NAN = "NaN", DEFAULT_DECIMAL_FORMAT = "#default";


	  /// <summary>
	  /// temp dummy </summary>
	  public const string ATTRNAME_XXXX = "XXXX";
	}
