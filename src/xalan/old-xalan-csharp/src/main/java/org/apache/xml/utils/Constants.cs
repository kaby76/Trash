...
namespace org.apache.xml.utils
{
	...
	public class Constants
	{
	  ...
	  /// </ul> 
	  /// </summary>
	  public const string S_XMLNAMESPACEURI = "http://www.w3.org/XML/1998/namespace", S_XSLNAMESPACEURL = "http://www.w3.org/1999/XSL/Transform", S_OLDXSLNAMESPACEURL = "http://www.w3.org/XSL/Transform/1.0";
	  ...
	  /// </ul>
	  /// </summary>
	  public const string S_VENDOR = "Apache Software Foundation", S_VENDORURL = "http://xml.apache.org";
	  ...
	  /// </summary>
	  public const string S_BUILTIN_EXTENSIONS_URL = "http://xml.apache.org/xalan";

	  /// <summary>
	  /// The old built-in extension url. It is still supported for
	  /// backward compatibility.
	  /// </summary>
	  public const string S_BUILTIN_OLD_EXTENSIONS_URL = "http://xml.apache.org/xslt";
