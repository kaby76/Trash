...
//ORIGINAL LINE: java_cup.runtime.Symbol disambiguateStar() throws Exception
		...
		internal XPathLexer(java.io.Reader reader) : this()
		{
			...
			yy_reader = new System.IO.StreamReader(reader);
		}

		internal XPathLexer(System.IO.Stream instream) : this()
		{
			if (!InstanceFieldsInitialized)
			{
				InitializeInstanceFields();
...
//ORIGINAL LINE: int[][] res = new int[size1][size2];
			int[][] res = RectangularArrays.ReturnRectangularIntArray(size1, size2);
