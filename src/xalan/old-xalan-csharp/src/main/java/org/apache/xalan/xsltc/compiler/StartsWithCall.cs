 ...
 */
/*
 * $Id: StartsWithCall.java 468650 2006-10-28 07:03:30Z minchau $
 */
...
namespace org.apache.xalan.xsltc.compiler
{
	...
	/// </summary>
	internal sealed class StartsWithCall : FunctionCall
	{
		...
		/// </summary>
		public StartsWithCall(QName fname, ArrayList arguments) : base(fname, arguments)
		{
		}
...
//ORIGINAL LINE: public org.apache.xalan.xsltc.compiler.util.Type typeCheck(SymbolTable stable) throws org.apache.xalan.xsltc.compiler.util.TypeCheckError
		...
		if (argumentCount() != 2)
		{
			ErrorMsg err = new ErrorMsg(ErrorMsg.ILLEGAL_ARG_ERR, Name, this);
...
//ORIGINAL LINE: final org.apache.bcel.generic.InstructionList il = methodGen.getInstructionList();
		...
		il.append(new INVOKEVIRTUAL(cpg.addMethodref(Constants_Fields.STRING_CLASS, "startsWith", "(" + Constants_Fields.STRING_SIG + ")Z")));
		}
	}
