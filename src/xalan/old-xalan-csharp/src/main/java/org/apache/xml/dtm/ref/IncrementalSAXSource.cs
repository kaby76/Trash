...
namespace org.apache.xml.dtm.@ref
{
	...
	/// <summary>
	/// <para>IncrementalSAXSource is an API that delivers a small number of
	...
	public interface IncrementalSAXSource
	{
	  ...
	  /// </summary>
	  org.xml.sax.ext.LexicalHandler LexicalHandler {set;}

	  /// <summary>
	  ///  Register a SAX-style DTD handler for us to output to
	  /// </summary>
	  org.xml.sax.DTDHandler DTDHandler {set;}
	  ...
	  /// </summary>
	  /// <param name="parsemore"> If true, tells the incremental SAX stream to deliver
	  /// another chunk of events. If false, finishes out the stream.
	  /// </param>
	  /// <returns> Boolean.TRUE if the IncrementalSAXSource believes more data
	  /// may be available for further parsing. Boolean.FALSE if parsing
	  /// ran to completion, or was ended by deliverMoreNodes(false).
	  ///  </returns>
	  object deliverMoreNodes(bool parsemore);
