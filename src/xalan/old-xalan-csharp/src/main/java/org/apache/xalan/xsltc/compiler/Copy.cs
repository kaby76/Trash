...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.bcel.generic.LocalVariableGen name = methodGen.addLocalVariable2("name", org.apache.xalan.xsltc.compiler.util.Util.getJCRefType(Constants_Fields.STRING_SIG), null);
		LocalVariableGen name = methodGen.addLocalVariable2("name", Util.getJCRefType(Constants_Fields.STRING_SIG), null);
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int cpy = cpg.addInterfaceMethodref(Constants_Fields.DOM_INTF, "shallowCopy", "(" + Constants_Fields.NODE_SIG + Constants_Fields.TRANSLET_OUTPUT_SIG + ")" + Constants_Fields.STRING_SIG);
		int cpy = cpg.addInterfaceMethodref(Constants_Fields.DOM_INTF, "shallowCopy", "(" + Constants_Fields.NODE_SIG + Constants_Fields.TRANSLET_OUTPUT_SIG + ")" + Constants_Fields.STRING_SIG);
		il.append(new INVOKEINTERFACE(cpy, 3));
		il.append(DUP);
		name.Start = il.append(new ASTORE(name.Index));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.bcel.generic.BranchHandle ifBlock1 = il.append(new org.apache.bcel.generic.IFNULL(null));
		...
		il.append(new ALOAD(name.Index));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int lengthMethod = cpg.addMethodref(Constants_Fields.STRING_CLASS,"length","()I");
		int lengthMethod = cpg.addMethodref(Constants_Fields.STRING_CLASS,"length","()I");
		il.append(new INVOKEVIRTUAL(lengthMethod));
		length.Start = il.append(new ISTORE(length.Index));
...
//ORIGINAL LINE: final SyntaxTreeNode parent = getParent();
			...
			il.append(new ILOAD(length.Index));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.bcel.generic.BranchHandle ifBlock2 = il.append(new org.apache.bcel.generic.IFEQ(null));
		...
		length.End = il.append(new ILOAD(length.Index));
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final org.apache.bcel.generic.BranchHandle ifBlock3 = il.append(new org.apache.bcel.generic.IFEQ(null));
		...
		il.append(methodGen.loadHandler());
		name.End = il.append(new ALOAD(name.Index));
