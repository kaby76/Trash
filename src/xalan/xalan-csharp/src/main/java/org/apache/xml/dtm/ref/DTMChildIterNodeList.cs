...
namespace org.apache.xml.dtm.@ref
{
	...
	/// 
	/// </summary>
	public class DTMChildIterNodeList : DTMNodeListBase
	{
		...
		/// one.
		/// </summary>
		/// <param name="parentDTM"> The DTM containing this node </param>
		/// <param name="parentHandle"> DTM node-handle integer
		///  </param>
