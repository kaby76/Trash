...
namespace org.apache.xml.utils
{
	...
	/// @xsl.usage internal
	/// </summary>
	public class IntStack : IntVector
	{
	  ...
	  public IntStack(int blocksize) : base(blocksize)
	  {
	  }
	  ...
	  /// </summary>
	  /// <param name="v"> IntStack to copy </param>
	  public IntStack(IntStack v) : base(v)
	  {
	  }
	  ...
	  /// @since   JDK1.0 </returns>
	  public virtual int search(int o)
	  {
