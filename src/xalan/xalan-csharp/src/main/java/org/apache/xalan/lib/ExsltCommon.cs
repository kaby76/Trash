...
namespace org.apache.xalan.lib
{
	...
	public class ExsltCommon
	{
	  ...
	  public static string objectType(object obj)
	  {
		...
		else if (obj is DTMNodeIterator)
		{
		  DTMIterator dtmI = ((DTMNodeIterator)obj).DTMIterator;
		  if (dtmI is org.apache.xpath.axes.RTFIterator)
		  {
			  return "RTF";
		  }
		  else
	  ...
	  /// </summary>
	  /// <param name="myProcessor"> is passed in by the Xalan extension processor </param>
	  /// <param name="rtf"> The result tree fragment to be converted to a node-set.
	  /// </param>
