...
namespace org.apache.xml.utils
{
	...
	public interface PrefixResolver
	{
	  ...
	  /// </param>
	  /// <returns> The associated Namespace URI as a string, or null if the prefix
	  ///         is undeclared in this context. </returns>
	  ...
	  /// </summary>
	  /// <returns> The base identifier from where relative URIs should be absolutized, or null 
	  ...
	  /// may not accurately reflect that context information. </returns>
