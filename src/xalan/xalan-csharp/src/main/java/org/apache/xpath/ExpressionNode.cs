...
namespace org.apache.xpath
{
	...
	/// 
	/// <para>Note: This interface should not be considered stable.  Only exprSetParent 
	/// and exprGetParent can be counted on to work reliably.  Work in progress.</para>
	/// </summary>
	public interface ExpressionNode : SourceLocator
	{
	  /// <summary>
