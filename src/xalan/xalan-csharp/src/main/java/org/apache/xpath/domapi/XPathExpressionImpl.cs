...
namespace org.apache.xpath.domapi
{
	...
	internal class XPathExpressionImpl : XPathExpression
	{
	  ...
	  private readonly Document m_doc;
		...
		/// </summary>
		/// <param name="xpath"> The wrapped XPath object. </param>
		...
		internal XPathExpressionImpl(XPath xpath, Document doc)
		{
			m_xpath = xpath;
			m_doc = doc;
		}
		...
		/// <para>See also the <a href='http://www.w3.org/TR/2004/NOTE-DOM-Level-3-XPath-20040226'>Document Object Model (DOM) Level 3 XPath Specification</a>.</para>
		/// 
		/// <para>Evaluates this XPath expression and returns a result.</para> </summary>
		...
		///   This must be one of the type codes of <code>XPathResult</code>. </param>
