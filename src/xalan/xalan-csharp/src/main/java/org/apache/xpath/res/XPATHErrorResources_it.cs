...
namespace org.apache.xpath.res
{
	...
	/// @xsl.usage advanced
	/// </summary>
	public class XPATHErrorResources_it : ListResourceBundle
	{
	...
	public const string ER_IGNORABLE_WHITESPACE_NOT_HANDLED = "ER_IGNORABLE_WHITESPACE_NOT_HANDLED";
	 ...
	 public const string ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
	  ...
	  public virtual object[][] Contents
	  {
		  get
		  {
			return new object[][]
			{
				...
				new object[] {ER_CURRENT_NOT_ALLOWED_IN_MATCH, "La funzione corrente () non \u00e8 consentita in un modello di corrispondenza."},
				new object[] {ER_CURRENT_TAKES_NO_ARGS, "La funzione corrente () non accetta argomenti."},
				new object[] {ER_DOCUMENT_REPLACED, "L'implementazione della funzione documento () \u00e8 stata sostituita da org.apache.xalan.xslt.FuncDocument."},
				new object[] {ER_CONTEXT_HAS_NO_OWNERDOC, "il contesto non ha un documento proprietario."},
				new object[] {ER_LOCALNAME_HAS_TOO_MANY_ARGS, "local-name() ha troppi argomenti."},
				new object[] {ER_NAMESPACEURI_HAS_TOO_MANY_ARGS, "namespace-uri() ha troppi argomenti."},
				new object[] {ER_NORMALIZESPACE_HAS_TOO_MANY_ARGS, "normalize-space() ha troppi argomenti."},
				new object[] {ER_NUMBER_HAS_TOO_MANY_ARGS, "number() ha troppi argomenti."},
				new object[] {ER_NAME_HAS_TOO_MANY_ARGS, "name() ha troppi argomenti."},
				new object[] {ER_STRING_HAS_TOO_MANY_ARGS, "string() ha troppi argomenti."},
				new object[] {ER_STRINGLENGTH_HAS_TOO_MANY_ARGS, "string-length() ha troppi argomenti."},
				new object[] {ER_TRANSLATE_TAKES_3_ARGS, "La funzione translate() richiede tre argomenti."},
				new object[] {ER_UNPARSEDENTITYURI_TAKES_1_ARG, "La funzione unparsed-entity-uri richiede un argomento."},
				new object[] {ER_NAMESPACEAXIS_NOT_IMPLEMENTED, "namespace axis non ancora implementato."},
				new object[] {ER_UNKNOWN_AXIS, "asse sconosciuto: {0}"},
				new object[] {ER_UNKNOWN_MATCH_OPERATION, "operazione di corrispondenza sconosciuta."},
				new object[] {ER_INCORRECT_ARG_LENGTH, "Lunghezza argomento nella prova nodo processing-instruction() non corretta."},
				new object[] {ER_CANT_CONVERT_TO_NUMBER, "Impossibile convertire {0} in un numero"},
				new object[] {ER_CANT_CONVERT_TO_NODELIST, "Impossibile convertire {0} in un NodeList."},
				new object[] {ER_CANT_CONVERT_TO_MUTABLENODELIST, "Impossibile convertire {0} in un NodeSetDTM."},
				new object[] {ER_CANT_CONVERT_TO_TYPE, "Impossibile convertire {0} in un type#{1}"},
				new object[] {ER_EXPECTED_MATCH_PATTERN, "Modello corrispondenza previsto in getMatchScore!"},
				new object[] {ER_COULDNOT_GET_VAR_NAMED, "Impossibile richiamare la variabile denominata {0}"},
				new object[] {ER_UNKNOWN_OPCODE, "ERRORE! Codice operativo sconosciuto: {0}"},
				new object[] {ER_EXTRA_ILLEGAL_TOKENS, "Token aggiuntivi non validi: {0}"},
				new object[] {ER_EXPECTED_DOUBLE_QUOTE, "letterale con numero di apici errato... previsti i doppi apici."},
				new object[] {ER_EXPECTED_SINGLE_QUOTE, "letterale con numero di apici errato... previsto un solo apice."},
				new object[] {ER_EMPTY_EXPRESSION, "Espressione vuota."},
				new object[] {ER_EXPECTED_BUT_FOUND, "Era previsto {0}, ma \u00e8 stato trovato: {1}"},
				new object[] {ER_INCORRECT_PROGRAMMER_ASSERTION, "Asserzione programmatore errata. - {0}"},
				new object[] {ER_BOOLEAN_ARG_NO_LONGER_OPTIONAL, "Argomento boolean(...) non pi\u00f9 facoltativo con la versione 19990709 XPath."},
				new object[] {ER_FOUND_COMMA_BUT_NO_PRECEDING_ARG, "Trovata ',' senza argomento che la precede."},
				new object[] {ER_FOUND_COMMA_BUT_NO_FOLLOWING_ARG, "Trovata ',' senza argomento che la segue."},
				new object[] {ER_PREDICATE_ILLEGAL_SYNTAX, "'..[predicato]' o '.[predicato]' \u00e8 una sintassi non valida.  Utilizzare 'self::node()[predicato]'."},
				new object[] {ER_ILLEGAL_AXIS_NAME, "nome asse non valido: {0}"},
				new object[] {ER_UNKNOWN_NODETYPE, "Nodetype sconosciuto: {0}"},
				new object[] {ER_PATTERN_LITERAL_NEEDS_BE_QUOTED, "Il letterale modello ({0}) deve essere racchiuso fra virgolette."},
				new object[] {ER_COULDNOT_BE_FORMATTED_TO_NUMBER, "{0} non pu\u00f2 essere formattato in un numero."},
				new object[] {ER_COULDNOT_CREATE_XMLPROCESSORLIAISON, "Impossibile creare XML TransformerFactory Liaison: {0}"},
				new object[] {ER_DIDNOT_FIND_XPATH_SELECT_EXP, "Errore! Impossibile trovare espressione selezione xpath (-select)."},
				new object[] {ER_COULDNOT_FIND_ENDOP_AFTER_OPLOCATIONPATH, "ERRORE! Impossibile trovare ENDOP dopo OP_LOCATIONPATH"},
				new object[] {ER_ERROR_OCCURED, "Si \u00e8 verificato un errore."},
				new object[] {ER_ILLEGAL_VARIABLE_REFERENCE, "VariableReference fornito per la variabile \u00e8 fuori contesto o senza definizione.  Nome = {0}"},
				new object[] {ER_AXES_NOT_ALLOWED, "Sono consentiti solo gli assi child:: e attribute:: nei modelli di corrispondenza.  Violazione asse = {0}"},
				new object[] {ER_KEY_HAS_TOO_MANY_ARGS, "key() con numero di argomenti scorretto."},
				new object[] {ER_COUNT_TAKES_1_ARG, "La funzione count richiede un argomento."},
				new object[] {ER_COULDNOT_FIND_FUNCTION, "Impossibile trovare la funzione: {0}"},
				new object[] {ER_UNSUPPORTED_ENCODING, "Codifica non supportata: {0}"},
				new object[] {ER_PROBLEM_IN_DTM_NEXTSIBLING, "Si \u00e8 verificato un problema in DTM durante l'esecuzione di getNextSibling... tentativo di recupero in corso"},
				new object[] {ER_CANNOT_WRITE_TO_EMPTYNODELISTIMPL, "Errore di programmazione: Impossibile scrivere su EmptyNodeList."},
				new object[] {ER_SETDOMFACTORY_NOT_SUPPORTED, "setDOMFactory non supportato da XPathContext!"},
				new object[] {ER_PREFIX_MUST_RESOLVE, "Il prefisso deve risolvere in uno namespace: {0}"},
				new object[] {ER_PARSE_NOT_SUPPORTED, "parse (InputSource source) non supportato in XPathContext! Impossibile aprire {0}"},
				new object[] {ER_SAX_API_NOT_HANDLED, "Caratteri SAX API (char ch[]... non gestiti da DTM!"},
				new object[] {ER_IGNORABLE_WHITESPACE_NOT_HANDLED, "ignorableWhitespace(char ch[]... non gestiti da DTM!"},
				new object[] {ER_DTM_CANNOT_HANDLE_NODES, "DTMLiaison non pu\u00f2 gestire i nodi di tipo {0}"},
				new object[] {ER_XERCES_CANNOT_HANDLE_NODES, "DOM2Helper non pu\u00f2 gestire i nodi di tipo {0}"},
				new object[] {ER_XERCES_PARSE_ERROR_DETAILS, "Errore DOM2Helper.parse: SystemID - {0} riga - {1}"},
				new object[] {ER_XERCES_PARSE_ERROR, "Errore DOM2Helper.parse"},
				new object[] {ER_INVALID_UTF16_SURROGATE, "Rilevato surrogato UTF-16 non valido: {0} ?"},
				new object[] {ER_OIERROR, "Errore IO"},
				new object[] {ER_CANNOT_CREATE_URL, "Impossibile creare url per: {0}"},
				new object[] {ER_XPATH_READOBJECT, "In XPath.readObject: {0}"},
				new object[] {ER_FUNCTION_TOKEN_NOT_FOUND, "token funzione non trovato."},
				new object[] {ER_CANNOT_DEAL_XPATH_TYPE, "Impossibile gestire il tipo XPath: {0}"},
				new object[] {ER_NODESET_NOT_MUTABLE, "Questo NodeSet non \u00e8 trasformabile"},
				new object[] {ER_NODESETDTM_NOT_MUTABLE, "Questo NodeSetDTM non \u00e8 trasformabile"},
				new object[] {ER_VAR_NOT_RESOLVABLE, "Variabile non risolvibile: {0}"},
				new object[] {ER_NULL_ERROR_HANDLER, "Handler errori nullo"},
				new object[] {ER_PROG_ASSERT_UNKNOWN_OPCODE, "Asserzione di programmatore: codice operativo sconosciuto: {0}"},
				new object[] {ER_ZERO_OR_ONE, "0 oppure 1"},
				new object[] {ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "rtf() non supportato da XRTreeFragSelectWrapper"},
				new object[] {ER_RTF_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "asNodeIterator() non supportato da XRTreeFragSelectWrapper"},
				new object[] {ER_DETACH_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "detach() non supportato da XRTreeFragSelectWrapper"},
				new object[] {ER_NUM_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "num() non supportato da XRTreeFragSelectWrapper"},
				new object[] {ER_XSTR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "xstr() non supportato da XRTreeFragSelectWrapper"},
				new object[] {ER_STR_NOT_SUPPORTED_XRTREEFRAGSELECTWRAPPER, "str() non supportato da XRTreeFragSelectWrapper"},
				new object[] {ER_FSB_NOT_SUPPORTED_XSTRINGFORCHARS, "fsb() non supportato per XStringForChars"},
				new object[] {ER_COULD_NOT_FIND_VAR, "Impossibile trovare la variabile con il nome {0}"},
				new object[] {ER_XSTRINGFORCHARS_CANNOT_TAKE_STRING, "XStringForChars non pu\u00f2 accettare una stringa come argomento"},
				new object[] {ER_FASTSTRINGBUFFER_CANNOT_BE_NULL, "L'argomento FastStringBuffer non pu\u00f2 essere nullo"},
				new object[] {ER_TWO_OR_THREE, "2 o 3"},
				new object[] {ER_VARIABLE_ACCESSED_BEFORE_BIND, "Variabile acceduta prima che fosse delimitata."},
				new object[] {ER_FSB_CANNOT_TAKE_STRING, "XStringForFSB non pu\u00f2 accettare una stringa come argomento."},
				new object[] {ER_SETTING_WALKER_ROOT_TO_NULL, "\n !!!! Errore! Si sta impostando il nodo di partenza su null"},
				new object[] {ER_NODESETDTM_CANNOT_ITERATE, "NodeSetDTM non pu\u00f2 collegarsi al nodo precedente"},
				new object[] {ER_NODESET_CANNOT_ITERATE, "NodeSet non pu\u00f2 collegarsi al nodo precedente"},
				new object[] {ER_NODESETDTM_CANNOT_INDEX, "NodeSetDTM non pu\u00f2 eseguire l'indicizzazione o il conteggio delle funzioni."},
				new object[] {ER_NODESET_CANNOT_INDEX, "NodeSet non pu\u00f2 eseguire l'indicizzazione o il conteggio delle funzioni."},
				new object[] {ER_CANNOT_CALL_SETSHOULDCACHENODE, "Impossibile chiamare setShouldCacheNodes dopo aver chiamato nextNode."},
				new object[] {ER_ONLY_ALLOWS, "{0} consente solo {1} argomenti"},
				new object[] {ER_UNKNOWN_STEP, "Asserzione di programmatore in getNextStepPos: stepType sconosciuto: {0}"},
				new object[] {ER_EXPECTED_REL_LOC_PATH, "Era previsto un percorso relativo dopo il token '/' oppure '//'."},
				new object[] {ER_EXPECTED_LOC_PATH, "Era previsto un percorso, ma \u00e8 stato rilevato il seguente token\u003a  {0}"},
				new object[] {ER_EXPECTED_LOC_PATH_AT_END_EXPR, "Era previsto un percorso, ma invece \u00e8 stata trovata la fine dell'espressione XPath."},
				new object[] {ER_EXPECTED_LOC_STEP, "Era previsto un passo di posizione dopo il token '/' oppure '//'."},
				new object[] {ER_EXPECTED_NODE_TEST, "Era prevista una prova nodo che corrisponde a NCName:* oppure a QName."},
				new object[] {ER_EXPECTED_STEP_PATTERN, "Era previsto un modello passo, ma \u00e8 stato rilevato '/'."},
				new object[] {ER_EXPECTED_REL_PATH_PATTERN, "Era previsto un modello percorso relativo."},
				new object[] {ER_CANT_CONVERT_TO_BOOLEAN, "XPathResult dell''''espressione XPath ''{0}'' ha un XPathResultType di {1} che non pu\u00f2 essere convertito in valore booleano."},
				new object[] {ER_CANT_CONVERT_TO_SINGLENODE, "XPathResult dell''''espressione XPath ''{0}'' ha un XPathResultType di {1} che non pu\u00f2 essere convertito in un nodo singolo. Il metodo getSingleNodeValue si applica solo ai tipi ANY_UNORDERED_NODE_TYPE eFIRST_ORDERED_NODE_TYPE."},
				new object[] {ER_CANT_GET_SNAPSHOT_LENGTH, "Il metodo getSnapshotLength non pu\u00f2 essere chiamato al XPathResult dell''''espressione XPath ''{0}'' poich\u00e9 il XPathResultType \u00e8 {1}. Questo metodo si applica solo ai tipi UNORDERED_NODE_SNAPSHOT_TYPE e ORDERED_NODE_SNAPSHOT_TYPE."},
				new object[] {ER_NON_ITERATOR_TYPE, "Il metodo iterateNext non pu\u00f2 essere chiamato in XPathResult dell''''espressione XPath ''{0}'' poich\u00e9 XPathResultType \u00e8 {1}. Questo metodo si applica solo ai tipi UNORDERED_NODE_ITERATOR_TYPE e ORDERED_NODE_ITERATOR_TYPE."},
				new object[] {ER_DOC_MUTATED, "Documento modificato da quando \u00e8 stato restituito il risultato. Iteratore non valido."},
				new object[] {ER_INVALID_XPATH_TYPE, "Argomento di tipo XPath non valido: {0}"},
				new object[] {ER_EMPTY_XPATH_RESULT, "Oggetto risultato XPath vuoto"},
				new object[] {ER_INCOMPATIBLE_TYPES, "XPathResult dell''''espressione XPath ''{0}'' ha un XPathResultType di {1} che non pu\u00f2 essere convertito nel XPathResultType specificato di {2}."},
				new object[] {ER_NULL_RESOLVER, "Impossibile risolvere il prefisso con resolver di prefisso nullo."},
				new object[] {ER_CANT_CONVERT_TO_STRING, "XPathResult dell''''espressione XPath ''{0}'' ha un XPathResultType di {1} che non pu\u00f2 essere convertito in una stringa."},
				new object[] {ER_NON_SNAPSHOT_TYPE, "Il metodo snapshotItem non pu\u00f2 essere chiamato al XPathResult dell''''espressione XPath ''{0}''  poich\u00e9 XPathResultType \u00e8 {1}. Questo metodo si applica solo ai tipi UNORDERED_NODE_SNAPSHOT_TYPE eORDERED_NODE_SNAPSHOT_TYPE."},
				new object[] {ER_WRONG_DOCUMENT, "Il nodo di contesto non appartiene al documento collegato a questo XPathEvaluator."},
				new object[] {ER_WRONG_NODETYPE, "Il tipo di nodo di contesto non \u00e8 supportato."},
				new object[] {ER_XPATH_ERROR, "Errore sconosciuto in XPath."},
				new object[] {ER_CANT_CONVERT_XPATHRESULTTYPE_TO_NUMBER, "XPathResult dell''''espressione XPath ''{0}'' ha un XPathResultType di {1} che non pu\u00f2 essere convertito in un numero"},
				new object[] {ER_EXTENSION_FUNCTION_CANNOT_BE_INVOKED, "Funzione di estensione: Impossibile richiamare ''{0}'' quando la funzione XMLConstants.FEATURE_SECURE_PROCESSING \u00e8 impostata su true."},
				new object[] {ER_RESOLVE_VARIABLE_RETURNS_NULL, "resolveVariable per la variabile {0} che restituisce null"},
				new object[] {ER_UNSUPPORTED_RETURN_TYPE, "Tipo di ritorno non supportato : {0}"},
				new object[] {ER_SOURCE_RETURN_TYPE_CANNOT_BE_NULL, "Il tipo origine e/o ritorno non pu\u00f2 essere nullo"},
				new object[] {ER_ARG_CANNOT_BE_NULL, "L''''argomento {0} non pu\u00f2 essere nullo"},
				new object[] {ER_OBJECT_MODEL_NULL, "{0}#isObjectModelSupported( String objectModel ) non pu\u00f2 essere chiamato con objectModel == null"},
				new object[] {ER_OBJECT_MODEL_EMPTY, "{0}#isObjectModelSupported( String objectModel ) non pu\u00f2 essere chiamato con objectModel == \"\""},
				new object[] {ER_FEATURE_NAME_NULL, "Tentativo di impostare una funzione con un nome nullo: {0}#setFeature( null, {1})"},
				new object[] {ER_FEATURE_UNKNOWN, "Tentativo di impostare una funzione sconosciuta \"{0}\":{1}#setFeature({0},{2})"},
				new object[] {ER_GETTING_NULL_FEATURE, "Tentativo di ottenere una funzione con un nome nullo: {0}#getFeature(null)"},
				new object[] {ER_GETTING_UNKNOWN_FEATURE, "Tentativo di ottenere una funzione sconosciuta \"{0}\":{1}#getFeature({0})"},
				new object[] {ER_NULL_XPATH_FUNCTION_RESOLVER, "Tentativo di impostare un XPathFunctionResolver:{0}#setXPathFunctionResolver(null) nullo"},
				new object[] {ER_NULL_XPATH_VARIABLE_RESOLVER, "Tentativo di impostare una XPathVariableResolver:{0}#setXPathVariableResolver(null) nulla"},
				new object[] {WG_LOCALE_NAME_NOT_HANDLED, "nome locale nella funzione format-number non ancora gestito."},
				new object[] {WG_PROPERTY_NOT_SUPPORTED, "Propriet\u00e0 XSL non supportata: {0}"},
				new object[] {WG_DONT_DO_ANYTHING_WITH_NS, "Non eseguire alcune azione per lo namespace {0} nella propriet\u00e0: {1}"},
				new object[] {WG_SECURITY_EXCEPTION, "SecurityException durante il tentativo di accesso alla propriet\u00e0 di sistema XSL: {0}"},
				new object[] {WG_QUO_NO_LONGER_DEFINED, "Sintassi obsoleta: quo(...) non \u00e8 pi\u00f9 definito in XPath."},
				new object[] {WG_NEED_DERIVED_OBJECT_TO_IMPLEMENT_NODETEST, "XPath richiede un oggetto derivato per implementare nodeTest!"},
				new object[] {WG_FUNCTION_TOKEN_NOT_FOUND, "token funzione non trovato."},
				new object[] {WG_COULDNOT_FIND_FUNCTION, "Impossibile trovare la funzione: {0}"},
				new object[] {WG_CANNOT_MAKE_URL_FROM, "Impossibile ricavare l''''URL da: {0}"},
				new object[] {WG_EXPAND_ENTITIES_NOT_SUPPORTED, "Opzione -E non supportata per il parser DTM"},
				new object[] {WG_ILLEGAL_VARIABLE_REFERENCE, "VariableReference fornito per la variabile \u00e8 fuori contesto o senza definizione.  Nome = {0}"},
				new object[] {WG_UNSUPPORTED_ENCODING, "Codifica non supportata: {0}"},
				...
				new object[] {"xpath_option", "opzioni xpath: "},
				new object[] {"optionIN", "   [-in inputXMLURL]"},
				new object[] {"optionSelect", "   [-select espressione xpath]"},
				new object[] {"optionMatch", "   [-match associa il modello (per le diagnostiche di corrispondenza)]"},
				new object[] {"optionAnyExpr", "Oppure per un'espressione xpath eseguir\u00e0 un dump diagnostico"},
	  ...
	  public const string ERROR_STRING = "#errore";
