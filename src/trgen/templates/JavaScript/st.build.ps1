...
<elseif(antlrng_tool)>
$(& pwsh .node_modules/.bin/antlr-ng.ps1 --encoding <antlr_encoding> -Dlanguage=JavaScript <x.AntlrArgs> <antlr_tool_args:{y | <y> } > <x.GrammarFileName> ; $compile_exit_code = $LASTEXITCODE) | Write-Host
<endif>
