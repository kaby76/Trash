...
public class Config
{
    ...
    [Option('i', "ignore", Required = false, Separator = ',',
        HelpText = "Ignored files or directories for generating app.")]
    ...
    public string template_sources_directory
    {
        get { return _backing_template_sources_directory; }
        set { _backing_template_sources_directory = Path.GetFullPath(value); }
    }
