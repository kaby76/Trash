...
namespace Trash
{
    public class GrammarTuple
    {
        ...
        public GrammarTuple(Type type, string source_grammar_file_name, string target_grammar_file_name, string grammar_name,
            string start_symbol,
            AntlrJson.ParsingResultSet pr, string generated_file_name, string generated_include_file_name, string grammar_autom_name, string grammar_go_new_name, string antlr_args)
        {
            WhatType = type;
