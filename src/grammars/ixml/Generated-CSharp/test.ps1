...
Write-Host "Test cases: '..\examples\*.ixml' '..\examples\ixml\samples\**\*.ixml' '!..\examples\ixml\samples\**\*.decorated.ixml'"
...
$allFiles = $(& dotnet trash glob '..\examples\*.ixml' '..\examples\ixml\samples\**\*.ixml' '!..\examples\ixml\samples\**\*.decorated.ixml' ; $last = $LASTEXITCODE )
