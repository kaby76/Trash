...
{
    public static ixmlParser Parser { get; set; }
    public static ErrorListener<IToken> ParserErrorListener { get; set; }
    public static ixmlLexer Lexer { get; set; }
    ...
    public static string StartSymbol { get; set; } = "ixml";
