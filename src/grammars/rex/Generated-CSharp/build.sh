...
antlr4 -v $version -encoding utf-8 -Dlanguage=CSharp -visitor -listener   rexLexer.g4
antlr4 -v $version -encoding utf-8 -Dlanguage=CSharp -visitor -listener   rexParser.g4
