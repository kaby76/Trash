...
{
    public static AbnfParser Parser { get; set; }
    public static ErrorListener<IToken> ParserErrorListener { get; set; }
    public static AbnfLexer Lexer { get; set; }
    ...
    public static string StartSymbol { get; set; } = "rulelist";
